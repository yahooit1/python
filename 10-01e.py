...
def myFunc() :
    if var.get()==1:
        ...
        LabelImage.comfigure(image=photo3)



var, labelImage=0,None
photo1,photo2,phto3=[None]*3

if __name__ == "__main__" :
    window=Tk()
    window.geometry("400x400")
    window.title("애완동물 선택하기")
    labeTest=Label(window,text="좋아하는 동물 투표",fg="blue",font=("궁서체",20))
    ...
    labelImage=Label(window,width=200,height=200,gb="yellow",image=None)
